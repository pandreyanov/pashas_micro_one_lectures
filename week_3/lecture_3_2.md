...
$$ I_0 := p hx(p,q, \bar U) + q hy(p,q, \bar U)$$
...
$$ E(p,q,\bar U) = p hx(p,q,\bar U) + q hy(p,q,\bar U).$$
...
Любой Маршалианский спроса $mx(p,q,I)$ совпадает с Хиксианским с подставленной косвенной функцией $hx(p,q,V(p,q,I))$. А любой Хиксианский спрос $hx(p,q,\bar U)$ совпадает с Маршалианским с подставленной функцией расходов $mx(p,q,E(p,q,\bar U))$.
:::
...
$$ E(p,q,\bar U) = p hx(p,q,\bar U) + q hy(p,q,\bar U), \quad \frac{\partial E}{\partial p} = ?$$
...
но это ничего не меняет, так как прибавка не зависит от параметров.
:::
...
- маршалианский спрос $mx(p,q,I), my(p,q,I)$ и косвенная полезность $V(p,q,I)$ в первой задаче
- хиксианский спрос $hx(p,q,\bar U), hy(p,q,\bar U)$ и функция расходов $E(p,q,\bar U)$ во второй задаче
...
Вся "схема перемещений" изображена на этом рисунке...
