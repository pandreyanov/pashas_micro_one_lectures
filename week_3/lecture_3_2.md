...
:class: remark
Если полезность (квази-)вогнутая и локально ненасыщаемая, то любое решение $P1$ воспроизводится как одно из решений $P2$ и наоборот. То есть, $P1 и P2$ эквивалентны.
:::
