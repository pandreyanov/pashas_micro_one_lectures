...
такой, что задача минимизации расходов с $(p, q, \bar U_0)$ эквивалентна ей. Аналогично, для задачи миимизации расходов с $(p, q, \bar U)$ существует
...
И прямо так и дифференциируем ее по ценам.
