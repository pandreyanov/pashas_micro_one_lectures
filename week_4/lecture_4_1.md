...
Пусть эластичности потребления товаров по собственной цене равны $\varepsilon_{x,p}$ и $\varepsilon_{y, q}$ соответственно, тогда оптимальные налоговые ставки пропорциональны обратным эластичностям обычниго (Маршалианского) спроса.

$$ \frac{\tau_x/p}{\tau_y/q} = \frac{1/\varepsilon_{p,x}}{1/\varepsilon_{q,y}}$$
