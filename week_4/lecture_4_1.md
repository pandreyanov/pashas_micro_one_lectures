...
Максимизация чистых налоговых сбров тут не представляет сложности – надо просто выставить $\tau = 1$, то есть отобрать все деньги. Максимизация косвенной полезности при фиксированных налоговых сборах тоже тривиальна: $\tau = T/I$.
