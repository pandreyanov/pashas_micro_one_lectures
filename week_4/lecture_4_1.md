...
$$ p х^{\ast} = \alpha \frac{1}{\lambda}, \quad q y^{\ast} = \beta \frac{1}{\lambda}$$

Складывается впечатление, что **оптимальные налоги устроены так, что они не меняют доли расходов, потраченные на каждый товар**.

:::{tip}
Оптимальные налоги - не искажают потребление.
:::
