...
Свойство вогнутости очень сильно опиратеся на геометрическую форму полезности. Грубо говоря, поверхность, соответствующая вогнутой полезности находится выше всех своих хорд.
...
Зато большим смыслом обладает понятие квази-вогнутости. Оно опирается не на геометрическую форму полезности, а на геометрическую форму Лебеговых множеств. 

У квази-вогнутости тоже будут две версии, которые почти (но не совсем) эквивалентны друг другу.

:::{prf:definition}
Полезность $U$ **квази-вогнутa** в $X$, если для любого $x \in X$ множество $L_{+}(x)$ выпукло, то есть, оно содержит все свои хорды. 
:::

Чтобы обвинить функцию в не квази-вогнутости, достаточно предъявить один $L_{+}(x)$ и продемонстрировать, что какая то хорда вылезает за его границы.
