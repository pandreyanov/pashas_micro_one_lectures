...
Таким образом, суммарную прибыль фирмы-производителя можно записать в виде:
...
Осталось убедиться, что вообще можно пользоваться методом Лагранжа здесь. Ответ простой - задача выпуклая, потому что $F$ вогнутая. Но почему недостаточно квазивогнутости $F$? Ответ - линейные члены в лагранжиане не могут поломать вогнутость, но они могут сломать квазивогнутость.
...
:::{note}
**Маржинальные издержки** $MC$ определяются как приращение функции издержек при увеличении производства, то есть: 
...
но тогда не было бы так интересно.
...
Таким образом, мы доказали, сами того не ожидая, следующее утверждение:
