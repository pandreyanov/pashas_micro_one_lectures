...
:::{prf:definition}
Назовем **фиксированными издержками** $FC$$- такие издержки, которые не зависят от объема производства: получить лицензию, арендовать помещение, и.т.д. Назовем **маржинальными издержками** $MC$ - дополнительные (или маржинальные) издержки на производтство дополнительной единицы товара. То есть
