...
Субсидии $T$ равны размеру субсидии, умноженной на равновесный $Q$.
В обоих случаях DWL - это площадь маленького треугольника слева (для налога) или справа (для субсидии) от точки равновесия.
...
Для простоты, у нас будет одна кривая (иностранного) спроса $P = 8 - Q$ и одна кривая (домашнего) предложения $P = Q$. Дефолтное равновесие ищется тривиально геометрически, это $P^{\ast} = Q^{\ast} = 4$. Теперь введем налог размера $\tau$.

> Как изменится равновесие и $TS = PS + T$?

## Налоги и импорт

Заметим, что DWL равен нулю когда налоги или субсидии отсутствуют. То есть, наилучшим является ситуация, в которой 
