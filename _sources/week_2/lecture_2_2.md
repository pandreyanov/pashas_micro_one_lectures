...
$$ s_x = \alpha, \quad s_y = 1 - \alpha,$$ откуда спрос уже совсем легко вывести.
...
где $f$ - вогнутая функция. Интерпретация последней координаты - это деньги на счету. То есть, вам не обязательно тратить весь бюджет как раньше и остаток средств на счету конвертируется в утили по курсу 1:$k$.
