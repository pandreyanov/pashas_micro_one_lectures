...
Конечно, можно было сказать что ноль это что-то среднее между субститутами и комплементами, но исторически ноль закреплен именно за комплементами, поскольку полезность "уголки" называется "совершенные комплементы". 

Можно представить себе товары, которые еще более комплементарны чем совершенные комплементы $min(x/a,y/a)$.
