...
То есть, $CV$ и $EV$, это, очень приближенном, значение квадратичной формы матрицы Слуцкого на векторе приращения цен, разделенная пополам. Это уже довольно сложная технически теорема, поэтому только формулировка.
