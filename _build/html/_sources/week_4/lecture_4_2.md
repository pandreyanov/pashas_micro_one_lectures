...
На этой иллюстрации, эффект дохода (IE, переход от 1 к 2) можно измерить, в точности, эквивалентной вариацией, поскольку мы остаемся на кривой безразличия, соответствующей новой полезности. Эффект замещения (SE, переход от 1 к 2) можно измерить в точности разностью между $h_x$ в старых и новых ценах, так как это качение вдоль этой кривой безразличия.
...
На этой иллюстрации, эффект дохода (IE, переход от 1 к 2) можно измерить, в точности, компенсирующей вариацией, поскольку мы остаемся на кривой безразличия, соответствующей новой полезности.
