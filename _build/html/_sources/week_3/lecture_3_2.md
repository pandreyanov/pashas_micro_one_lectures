...
Чтобы не перепутать, какие роли у $x$ и у $p$, помните, что **огибающая - это функция от параметра $p$** а не от индекса опорной функции $x$. Соответственно, все наклоны измеряются по $p$.
