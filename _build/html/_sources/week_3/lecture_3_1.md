...
То есть, **индекс Лернера** это и есть маржа в долях (не в процентах). В Американских исследованиях, эластичность потребления многих товаров (например бензин) оценивается около 0.37. Соответственно, для типичной бензоколонки, индекс Лернера выше .37 считается серьезным признаком злоупотребления рыночной властью.
