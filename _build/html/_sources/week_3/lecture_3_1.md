...
Вообще говоря, **маржа** (по английски **markup**) это $p-c$, но, по причинам которые я озвучил в начале лекции, экономисты любят ее безразмерную версию $100(p-c)/p$, то есть **в процентах от цены**.
