...
Пусть на рынке установлена цена $P^{\ast}$ а маржинальные издержки (не обязательно постоянные) фирмы равны $MC$ при текущем обьеме.
...
В Американских исследованиях, "подозрительной" будет фирма, у которой индекс Лернера выше .35. Такие фирмы, как правило, находятся под пристальным взглядом Федеральной Торговой Комиссии - контролирующего органа США. 

Но почему? Ответ кроется в эластичностях.

### Формула обратной эластичности

Пусть спрос на товар $x$ описывается **обратной фунцкией спроса** $P(x)$ с постоянной эластичностью $\delta$, а издержки монополиста не зависят от объемов и равны $MC$. Тогда задача монополиста это:
...
Так вот, в Американских исследованиях установлено, что типичная эластичность (скажем, бензина) по цене равна приблизительно -.35. Соответственно, у бензоколонки, желающей злоупотребить своим монопольным положением, индекс Лернера будет как раз .35.

К сожалению, аккуратная оценка индекса Лернера практически невозможна, так как практически невозможно оценить истинные издержки фирмы, поэтому, сейчас для этого использутся более сложные метрики, например SSNIP.
...
В таких ситуациях, как правило, появляется "госмонополия" - фирма с колоссальной рыночной властью и политическим лобби. Основная задача ФАС - следить, чтобы она не пользовалась этой властью. 
