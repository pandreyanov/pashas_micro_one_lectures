...
Пусть спрос на товар $x$ описывается **обратной фунцкией спроса** $P(x)$ с постоянной эластичностью $\delta$, а издержки монополиста не зависят от объемов и равны $C$. Тогда задача монополиста это:
...
То есть, маржа (то что слева) равна минус эластичности обратной фунцкии спроса.

А как это связано с (прямой) функцией спроса? Оказывается, что у обратных функций эластичность - тоже обратная. То есть, 

:::{admonition} Утверждение
:class: important
Если у (прямой) функции спроса эластичность равна $\varepsilon$, то маржа (как доля от цены) монополиста (с постоянными издержками $c$) в оптимуме должна равняться в точности обратной эластичности, с минусом:

$$\frac{p-c}{p} = - \frac{1}{\varepsilon}$$

:::

Вообще говоря, **маржа** (по английски **markup**) это $p-c$, но, по причинам которые я озвучил в начале лекции, экономисты любят ее безразмерную версию $(p-c)/p$ или $100(p-c)/p$. Последнее выражение означает, что маржа озвучивается **в процентах от цены**.

### Индекс Лернера

Сейчас мы поставим себя на место контролирующего органа и будем решать, в некотором смысле, обратную задачу. Пусть спрос на товар $x$ описывается **обратной фунцкией спроса** $P(x)$ с постоянной эластичностью $\delta$, а маржинальные издержки (не обязательно постоянные) монополиста равны $MC$ при текущем обьеме. Цена установлена монополистом на уровне $P^{\ast}$.
...
То есть, **индекс Лернера** это и есть маржа в долях (не в процентах). 

В Американских исследованиях, эластичность потребления многих товаров (например бензин) оценивается около .37, соответственно, для типичной бензоколонки, индекс Лернера выше .37 вызовет интерес со стороны контролирующего органа (в США это Федеральная Торговая Комиссия, в России это Федеральная Антимонопольная Служба) и сулит судебные иски по поводу злоупотребления рыночной властью.
