...
Если вы применили преобразование $\log x$ чтобы быстрее решить задачу, и получили косвенную полезность, то вам придется ее "откатить", то есть применить обратное преобразование $e^x$, чтобы ответ был формально верным.
